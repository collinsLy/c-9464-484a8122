                  ...
                  <iframe 
                    ...
                    src={(() => {
                      const url = isDemoMode 
                        ...
                        : `https://app.payhero.co.ke/lipwa/1981?amount=${Math.round(kshAmount)}&name=${encodeURIComponent(userData?.fullName || userData?.name || 'Guest User')}&reference=${referenceNumber}`;
