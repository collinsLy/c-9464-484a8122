          ...
          <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e0e0e0; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
            ...
            <div style="padding: 30px;">
              ...
              <div style="text-align: center; margin-top: 30px;">
                <a href="${type === 'transfer' && isReceiver ? 'https://vertextradingscom.vercel.app/' : 'https://vertex-trading.replit.app'}" style="display: inline-block; padding: 15px 30px; background: linear-gradient(135deg, #ff7a00 0%, #ff9a40 100%); color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; box-shadow: 0 4px 12px rgba(255, 122, 0, 0.3);">
